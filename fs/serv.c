...
serve_read(envid_t envid, union Fsipc *ipc)
{
	...
	if ((r = openfile_lookup(envid, req->req_fileid, &o)) < 0)
		return r;
	req_n = MIN(PGSIZE, req->req_n);
	if((r = file_read(o->o_file, (void*)ret->ret_buf, req_n, o->o_fd->fd_offset)) < 0)
		return r;
	o->o_fd->fd_offset += r;
	return r;
}
...
serve_write(envid_t envid, struct Fsreq_write *req)
{
	...
	if((r = openfile_lookup(envid, req->req_fileid, &o)) < 0)
		return r;
	req_n = MIN(req->req_n, PGSIZE - (sizeof(int) + sizeof(size_t)));
	if((r = file_write(o->o_file, (void*)req->req_buf, req_n, o->o_fd->fd_offset)) < 0)
		return r;
	o->o_fd->fd_offset += r;
	return r;
}
